// contracts/mocks/LiquidityTestRouter.sol
...
contract LiquidityTestRouter {
    ...
    function getAmountsOut(uint256 amountIn, address[] calldata path) external view returns (uint256[] memory amounts) {
        ...
        amounts[path.length - 1] = manipulatePrice ? 1000 : amountIn / 1_000_000_000;
        return amounts;
    }
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        payable(to).transfer(actualAmountOut);
    }
